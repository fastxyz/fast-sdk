...
const toFastSetError = (message: string, rpcErr: (ProxyErrorData & { type: 'RpcError' })['value']) => {
...
export const parseRpcError = (err: { readonly code: number; readonly message: string; readonly data?: unknown }) => {
