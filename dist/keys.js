...
async function seedKeyfileFromEnvIfConfigured(keyPath) {
 ...
 * Expands `~` in the path.
 */
export async function loadKeyfile(path) {
 ...
 */
export async function saveKeyfile(keyPath, keypair) {
 ...
 */
export async function signEd25519(message, privateKeyHex) {
 ...
 */
export async function verifyEd25519(signature, message, publicKeyHex) {
    try {
 ...
 */
export async function withKey(keyfilePath, fn) {
