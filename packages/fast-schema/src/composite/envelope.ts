...
export const makeMultiSigConfig = <TAddr extends S, TQ extends S, TNonce extends S>(p: { Address: TAddr; Quorum: TQ; Nonce: TNonce }) =>
  CamelCaseStruct({ authorized_signers: Schema.Array(p.Address), quorum: p.Quorum, nonce: p.Nonce });

export const makeMultiSig = <TAddr extends S, TSig extends S, TQ extends S, TNonce extends S>(p: {
  Address: TAddr;
  Signature: TSig;
  Quorum: TQ;
  Nonce: TNonce;
...
export const makeSignatureOrMultiSig = <TAddr extends S, TSig extends S, TQ extends S, TNonce extends S>(p: {
  Address: TAddr;
  Signature: TSig;
  Quorum: TQ;
  Nonce: TNonce;
