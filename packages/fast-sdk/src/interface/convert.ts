...
export const toHex = (bytes: Uint8Array): string => `0x${Encoding.encodeHex(bytes)}`;
...
export const toFastAddress = (bytes: Uint8Array): string => bech32m.encode('fast', bech32m.toWords(bytes));
